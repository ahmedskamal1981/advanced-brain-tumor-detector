...
def upload_image():
    global img, img_tk, img_cv, current_image_path
    current_image_path = filedialog.askopenfilename(filetypes=[("Image files", "*.jpg *.jpeg *.png")])
...
def main_gui(root):
    ...
    upload_button = Button(upload_frame, text="Upload Image Folder", command=upload_folder, font=("times new roman", 12), bg="orange", fg="white")
